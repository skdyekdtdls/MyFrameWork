...
void ImGui::TableUpdateLayout(ImGuiTable* table)
{
    ...
    for (int order_n = 0; order_n < table->ColumnsCount; order_n++)
    {
        ...
        // Tick Enabled state, mark settings and sort specs dirty
...
void    ImGui::EndTable()
{
    ...
    // Tick ColumnsAutoFitWidth to get us ahead for host using our size to auto-resize without waiting for next BeginTable()
...
void ImGui::TableEndRow(ImGuiTable* table)
{
    ...
    if (unfreeze_rows_actual)
    {
        ...
        // Tick cliprect ahead of TableBeginCell() so clipper can access to new ClipRect->Min.y
