...
HRESULT CFont_Manager::Render_Font(const _tchar* pFontTag, const _tchar* pText, const _float2& vPosition, _fvector vColor, float fRotation, const _float2& vOrigin, _float fScale)
{
	auto	pFont = Find_Font(pFontTag);
