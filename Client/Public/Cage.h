...
private:
	static _uint Cage_Id;

public:
	static const _tchar* ProtoTag() { return L"Prototype_GameObject_Cage"; }
	static Cage* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
