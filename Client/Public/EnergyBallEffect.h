...
BEGIN(Client)
class EnergyBallEffect final : public CGameObject
{
public:
...
private:
	EnergyBallEffect(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	EnergyBallEffect(const EnergyBallEffect& rhs);
	virtual ~EnergyBallEffect() = default;
...
public:
	static const _tchar* ProtoTag() { return L"Prototype_GameObject_EnergyBallEffect"; }
	static EnergyBallEffect* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
