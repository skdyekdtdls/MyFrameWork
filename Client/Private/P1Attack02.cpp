...
_uint P1Attack02::P1Attack02_Id = 0;

/* Don't Forget Release for the VIBuffer or Model Component*/

P1Attack02::P1Attack02(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: Bullet(pDevice, pContext)
{
}

P1Attack02::P1Attack02(const P1Attack02& rhs)
	: Bullet(rhs)
{
}

HRESULT P1Attack02::Initialize_Prototype()
{
...
HRESULT P1Attack02::Initialize(void* pArg)
{
	...
	++P1Attack02_Id;
	m_tInfo.wstrName = TO_WSTR("P1Attack02" + to_string(P1Attack02_Id));
	m_tInfo.wstrKey = ProtoTag();
	m_tInfo.ID = P1Attack02_Id;

	tagP1Attack02Desc tP1Attack02Desc;
	if (nullptr != pArg)
		tP1Attack02Desc = *(tagP1Attack02Desc*)pArg;
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMLoadFloat4(&tP1Attack02Desc.vPosition));
...
void P1Attack02::Tick(_double TimeDelta)
{
...
void P1Attack02::Late_Tick(_double TimeDelta)
{
...
void P1Attack02::ResetPool(void* pArg)
{
	m_bDead = false;
	_vector vPosition = XMLoadFloat4(&((tagP1Attack02Desc*)pArg)->vPosition);
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, vPosition);
	m_pTimeCounterCom->Enable();
}

void P1Attack02::SetDead()
{
	__super::SetDead();
	ObjectPool<P1Attack02>::GetInstance()->PushPool(this);
	m_pTimeCounterCom->Reset();
	m_pTimeCounterCom->Disable();
}

HRESULT P1Attack02::Add_Components()
{
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
	...
	tColliderSphereDesc.fRadius = { 3.f };
...
HRESULT P1Attack02::SetUp_ShaderResources()
{
...
void P1Attack02::OnCollision(CCollider::COLLISION_INFO tCollisionInfo, _double TimeDelta)
{
...
P1Attack02* P1Attack02::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	P1Attack02* pInstance = new P1Attack02(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created P1Attack02");
		Safe_Release(pInstance);
	}
	return pInstance;
}

Bullet* P1Attack02::Clone(void* pArg)
{
	P1Attack02* pInstance = new P1Attack02(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned P1Attack02");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void P1Attack02::Free(void)
{
	__super::Free();
