...
HRESULT Bush01::Initialize(void* pArg)
{
	...
	tagBush01Desc tCloneDesc;
	if (nullptr != pArg)
		tCloneDesc = *(tagBush01Desc*)pArg;
...
HRESULT Bush01::Add_Components()
{
	...
	FAILED_CHECK_RETURN(__super::Add_Component(eLevelID, L"Prototype_Component_Model_Bush01", L"Com_Model", (CComponent**)&m_pModelCom, &tModelDesc), E_FAIL);
