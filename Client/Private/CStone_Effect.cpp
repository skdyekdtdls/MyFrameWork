...
void CStone_Effect::Tick(_double TimeDelta)
{
	...
	for (auto& Particle : m_Particles)
	{
		...
		if (Particle.WorldMatrix._42 <= 0.f)
		{
...
void CStone_Effect::Late_Tick(_double TimeDelta)
{
...
void CStone_Effect::Reset_Particle(STONEPARTICLE& Particle)
{
	...
	Particle.vVelocity = _float4(RandomFloat(-5.f, 5.f), RandomFloat(10.f, 15.f), RandomFloat(-5.f, 5.f), 0.f);
...
HRESULT CStone_Effect::Add_Components()
{
	...
	FAILED_CHECK_RETURN(__super::Add_Component(eNextLevel, L"Prototype_Component_Texture_Snow"
...
CStone_Effect* CStone_Effect::Clone(void* pArg)
{
