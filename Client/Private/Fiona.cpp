...
//	//m_tInfo.ID = Fiona_Id;
//
//	//FIONA_DESC tFionaDesc;
//	//ZeroStruct(tFionaDesc);
//	//tFionaDesc.vPosition = _float4(0.f, 0.f, 0.f, 1.f);
//	//if (nullptr != pArg)
//	//{
//	//	tFionaDesc = *(FIONA_DESC*)pArg;
//	//}
//	//m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMLoadFloat4(&tFionaDesc.vPosition));
//	//
...
//
//	//CCollider* pCollider = static_cast<CCollider*>(pGameInstance->Get_ComponentOfClone(LEVEL_IMGUI, L"Layer_Player", "Clint1", L"Com_BodyColl"));
//	//pCollider->Intersect(m_pColliderCom);
