...
_uint SM_GenericWall01::SM_GenericWall01_Id = 0;

SM_GenericWall01::SM_GenericWall01(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CGameObject(pDevice, pContext)
{
}

SM_GenericWall01::SM_GenericWall01(const SM_GenericWall01& rhs)
	: CGameObject(rhs)
{
}

HRESULT SM_GenericWall01::Initialize_Prototype()
{
...
HRESULT SM_GenericWall01::Initialize(void* pArg)
{
	...
	++SM_GenericWall01_Id;
	m_tInfo.wstrName = TO_WSTR("SM_GenericWall01" + to_string(SM_GenericWall01_Id));
	m_tInfo.wstrKey = ProtoTag();
	m_tInfo.ID = SM_GenericWall01_Id;

	tagSM_GenericWall01Desc tCloneDesc;
	if (nullptr != pArg)
		tCloneDesc = *(tagSM_GenericWall01Desc*)pArg;
...
void SM_GenericWall01::Tick(_double TimeDelta)
{
...
void SM_GenericWall01::Late_Tick(_double TimeDelta)
{
...
HRESULT SM_GenericWall01::Render()
{
...
void SM_GenericWall01::Save(HANDLE hFile, DWORD& dwByte)
{
	m_tInfo.Save(hFile, dwByte);
	m_pTransformCom->Save(hFile, dwByte);
}

void SM_GenericWall01::Load(HANDLE hFile, DWORD& dwByte, _uint iLevelIndex)
{
	m_pTransformCom->Load(hFile, dwByte, iLevelIndex);
}

HRESULT SM_GenericWall01::Add_Components()
{
	...
	FAILED_CHECK_RETURN(__super::Add_Component(eLevelID, L"Prototype_Component_Model_SM_GenericWall01", L"Com_Model", (CComponent**)&m_pModelCom, &tModelDesc), E_FAIL);
...
HRESULT SM_GenericWall01::SetUp_ShaderResources()
{
...
SM_GenericWall01* SM_GenericWall01::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	SM_GenericWall01* pInstance = new SM_GenericWall01(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created SM_GenericWall01");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* SM_GenericWall01::Clone(void* pArg)
{
	SM_GenericWall01* pInstance = new SM_GenericWall01(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned SM_GenericWall01");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void SM_GenericWall01::Free(void)
{
	__super::Free();
