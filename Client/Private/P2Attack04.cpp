...
_uint P2Attack04::P2Attack04_Id = 0;

/* Don't Forget Release for the VIBuffer or Model Component*/

P2Attack04::P2Attack04(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: Bullet(pDevice, pContext)
{
}

P2Attack04::P2Attack04(const P2Attack04& rhs)
	: Bullet(rhs)
{
}

HRESULT P2Attack04::Initialize_Prototype()
{
...
HRESULT P2Attack04::Initialize(void* pArg)
{
	...
	++P2Attack04_Id;
	m_tInfo.wstrName = TO_WSTR("P2Attack04" + to_string(P2Attack04_Id));
	m_tInfo.wstrKey = ProtoTag();
	m_tInfo.ID = P2Attack04_Id;

	tagP2Attack04Desc tP2Attack04Desc;
	if (nullptr != pArg)
		tP2Attack04Desc = *(tagP2Attack04Desc*)pArg;
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMLoadFloat4(&tP2Attack04Desc.vPosition));
...
void P2Attack04::Tick(_double TimeDelta)
{
	...
	m_pTransformCom->Jump(m_pTimeCounterCom->TimeElapse(), 1.f);
...
void P2Attack04::Late_Tick(_double TimeDelta)
{
...
void P2Attack04::ResetPool(void* pArg)
{
	m_bDead = false;
	_vector vPosition = XMLoadFloat4(&((tagP2Attack04Desc*)pArg)->vPosition);
	_vector vTargetPosition = ((tagP2Attack04Desc*)pArg)->vTargetPos;
...
void P2Attack04::SetDead()
{
	__super::SetDead();
	ObjectPool<P2Attack04>::GetInstance()->PushPool(this);
	m_pTimeCounterCom->Reset();
	m_pTimeCounterCom->Disable();
}

HRESULT P2Attack04::Add_Components()
{
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
...
HRESULT P2Attack04::SetUp_ShaderResources()
{
...
void P2Attack04::OnCollision(CCollider::COLLISION_INFO tCollisionInfo, _double TimeDelta)
{
...
P2Attack04* P2Attack04::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	P2Attack04* pInstance = new P2Attack04(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created P2Attack04");
		Safe_Release(pInstance);
	}
	return pInstance;
}

Bullet* P2Attack04::Clone(void* pArg)
{
	P2Attack04* pInstance = new P2Attack04(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned P2Attack04");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void P2Attack04::Free(void)
{
	__super::Free();
