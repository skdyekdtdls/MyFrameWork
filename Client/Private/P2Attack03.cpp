...
_uint P2Attack03::P2Attack03_Id = 0;

/* Don't Forget Release for the VIBuffer or Model Component*/

P2Attack03::P2Attack03(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: Bullet(pDevice, pContext)
{
}

P2Attack03::P2Attack03(const P2Attack03& rhs)
	: Bullet(rhs)
{
}

HRESULT P2Attack03::Initialize_Prototype()
{
...
HRESULT P2Attack03::Initialize(void* pArg)
{
	...
	++P2Attack03_Id;
	m_tInfo.wstrName = TO_WSTR("P2Attack03" + to_string(P2Attack03_Id));
	m_tInfo.wstrKey = ProtoTag();
	m_tInfo.ID = P2Attack03_Id;

	tagP2Attack03Desc tP2Attack03Desc;
	if (nullptr != pArg)
		tP2Attack03Desc = *(tagP2Attack03Desc*)pArg;
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMLoadFloat4(&tP2Attack03Desc.vPosition));
...
void P2Attack03::Tick(_double TimeDelta)
{
...
void P2Attack03::Late_Tick(_double TimeDelta)
{
...
void P2Attack03::ResetPool(void* pArg)
{
	m_bDead = false;
	_vector vPosition = XMLoadFloat4(&((tagP2Attack03Desc*)pArg)->vPosition);
...
void P2Attack03::SetDead()
{
	__super::SetDead();
	ObjectPool<P2Attack03>::GetInstance()->PushPool(this);
	m_pTimeCounterCom->Reset();
	m_pTimeCounterCom->Disable();
}

HRESULT P2Attack03::Add_Components()
{
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
	...
	tColliderSphereDesc.fRadius = { 2.f };
...
HRESULT P2Attack03::SetUp_ShaderResources()
{
...
void P2Attack03::OnCollision(CCollider::COLLISION_INFO tCollisionInfo, _double TimeDelta)
{
...
P2Attack03* P2Attack03::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	P2Attack03* pInstance = new P2Attack03(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created P2Attack03");
		Safe_Release(pInstance);
	}
	return pInstance;
}

Bullet* P2Attack03::Clone(void* pArg)
{
	P2Attack03* pInstance = new P2Attack03(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned P2Attack03");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void P2Attack03::Free(void)
{
	__super::Free();
