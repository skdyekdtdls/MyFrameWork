...
P2Attack02::P2Attack02(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: Bullet(pDevice, pContext)
{
}

P2Attack02::P2Attack02(const P2Attack02& rhs)
	: Bullet(rhs)
{
}

HRESULT P2Attack02::Initialize_Prototype()
{
...
HRESULT P2Attack02::Initialize(void* pArg)
{
	...
	++P2Attack02_Id;
	m_tInfo.wstrName = TO_WSTR("P2Attack02" + to_string(P2Attack02_Id));
	m_tInfo.wstrKey = ProtoTag();
	m_tInfo.ID = P2Attack02_Id;

	tagP2Attack02Desc tP2Attack02Desc;
	if (nullptr != pArg)
		tP2Attack02Desc = *(tagP2Attack02Desc*)pArg;
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMLoadFloat4(&tP2Attack02Desc.vPosition));
...
void P2Attack02::Tick(_double TimeDelta)
{
...
void P2Attack02::Late_Tick(_double TimeDelta)
{
...
void P2Attack02::ResetPool(void* pArg)
{
	m_bDead = false;
	_vector vPosition = XMLoadFloat4(&((tagP2Attack02Desc*)pArg)->vPosition);
...
void P2Attack02::SetDead()
{
	__super::SetDead();
	ObjectPool<P2Attack02>::GetInstance()->PushPool(this);
	m_pTimeCounterCom->Reset();
	m_pTimeCounterCom->Disable();
}

HRESULT P2Attack02::Add_Components()
{
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
...
HRESULT P2Attack02::SetUp_ShaderResources()
{
...
void P2Attack02::OnCollision(CCollider::COLLISION_INFO tCollisionInfo, _double TimeDelta)
{
...
P2Attack02* P2Attack02::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	P2Attack02* pInstance = new P2Attack02(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created P2Attack02");
		Safe_Release(pInstance);
	}
	return pInstance;
}

Bullet* P2Attack02::Clone(void* pArg)
{
	P2Attack02* pInstance = new P2Attack02(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned P2Attack02");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void P2Attack02::Free(void)
{
	__super::Free();
